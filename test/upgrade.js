...
contract("TransactionManager", (accounts) => {
  ...
  before(async () => {
    ...
    newModule = await EchoooModule.new(
      registry.address,
      guardianStorage.address,
      transferStorage.address,
      dappRegistry.address,
    ...
    await registry.registerModule(module.address, ethers.utils.formatBytes32String("EchoooMdoule"));
    await registry.registerModule(newModule.address, ethers.utils.formatBytes32String("NewEchoooModule"));
