...
contract FakeWallet is IWallet {
    ...
    function init(address _owner, address[] calldata _modules) external {
        ...
        require(
            _modules.length > 0,
            "BW: construction requires at least 1 module"
        );
        owner = _owner;
        ...
        moduleOnly
    {
        if (authorised[_module] != _value) {
            ...
            if (_value == true) {
                ...
                require(
                    modules > 0,
                    "BW: wallet must have at least one module"
                );
     ...
     */
    function enableStaticCall(address _module, bytes4 _method)
        external
        override
        moduleOnly
    {
